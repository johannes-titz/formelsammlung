...
\subsection*{Yules Q (für dichotome Variablen)}
...
\begin{tabular}{rl}
  ...
  $p_e$:&erwartete Übereinstimmung unter Zufall\\
  $p_{i\cdot}$:&die Randwahrscheinlichkeit der Zeile $i$\\
  $p_{\cdot i}$:&die Randwahrscheinlichkeit der Spalte $i$\\
