...
$$\hat{\sigma}_A^2=\frac{\mathrm{QS}_{A}}{\mathrm{df}_{A}}$$ $$\hat{\sigma}_B^2=\frac{\mathrm{QS}_{B}}{\mathrm{df}_{B}}$$  $$\hat{\sigma}_{A\times B}=\frac{\mathrm{QS}_{A\times B}}{\mathrm{df}_{A\times B}}$$
...
\mathrm{df}_{\mathrm{inn}}&=\sum\limits_j^k \sum\limits_l^m (n_{jl}-1) = N-k \\
...
\begin{align*}
\mathrm{QS}_{\mathrm{ges}}&=\mathrm{QS}_A+\mathrm{QS}_B+ \mathrm{QS}_{A\times B}+\mathrm{QS}_{inn}\\
...
\mathrm{QS}_{\mathrm{AxB}}&=\mathrm{QS}_{\mathrm{ges}}-\mathrm{QS}_{\mathrm{A}}-\mathrm{QS}_{\mathrm{B}}-\mathrm{QS}_{\mathrm{inn}}\\
\end{align*}
...
$x_j$: &Mittelwert für Faktor A\\
$x_i$: &Mittelwert für Faktor B\\
\end{tabular}
\end{multicols}
