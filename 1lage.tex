...
\begin{equation*}
\text{Tiefe}_{\mathrm{Med}}=\frac{n+1}{2}
\end{equation*}
...
\begin{equation*}
\text{Tiefe}_{\text{Quartil}}=\frac{\lfloor\text{Tiefe}_{\mathrm{Med}}\rfloor + 1}{2}
\end{equation*}
...
\begin{align*}
  \text{Zaun}_{\text{unten}}&= Q_{25}-1,5 \cdot \mathrm{IQA}\\
  \text{Zaun}_{\text{oben}} &= Q_{75}+1,5 \cdot \mathrm{IQA}
\end{align*}
