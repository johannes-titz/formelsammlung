...
$$\sigma_{\mathrm{Anzahl}}=\sqrt{n p (1-p)}$$
...
Bei Ungleichheit der Varianzen in der Population

\[
\hat{\sigma}_{\bar{x}_A - \bar{x}_B}
= \sqrt{\frac{\hat{\sigma}_A^2}{n_A} + \frac{\hat{\sigma}_B^2}{n_B}}
\]

\subsection*{Einfache lineare Regression}

% Standardfehler des Anstiegs
\[
\hat{\sigma}_{b_1}
=
\sqrt{
